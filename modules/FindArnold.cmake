...
message(STATUS "ARNOLD_HOME is ${ARNOLD_HOME}")

# Verify that ARNOLD_HOME points to a valid directory
if (NOT IS_DIRECTORY "${ARNOLD_HOME}")
    message(FATAL_ERROR "ARNOLD_HOME does not point to a valid directory. Please set it to point to the root directory of the Arnold SDK. This is the directory containing bin, include etc.")
endif()
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
    ...
    find_path(ARNOLD_LIBRARY_DIR
            NAMES ai.lib
            PATHS ${ARNOLD_HOME}/${ARNOLD_LIBDIR}
            )
else()
    find_path(ARNOLD_LIBRARY_DIR
